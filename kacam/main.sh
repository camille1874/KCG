...
# python main.py -t trecqa --no_entity_cmp --no_cxt_weight_mixed
# python main.py -t trecqa --no_entity_cmp
# python main.py -t trecqa --no_cxt_weight_mixed --no_ent_weight_mixed
# python main.py -t trecqa --no_cxt_weight_mixed
# python main.py -t trecqa --no_ent_weight_mixed
