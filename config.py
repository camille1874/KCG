...
configuration = {
    ...
    'default':{
        # Dataset and split
        'dataset'           : 'f3',       # 'Dataset (cora | citeseer | pubmed | large_cora | nell.0.1 | nell.0.01 | nell.0.001)
        #'dataset'           : 'f4',       # 'Dataset (cora | citeseer | pubmed | large_cora | nell.0.1 | nell.0.01 | nell.0.001)
        'shuffle'           : True,         # random split or not
        #'shuffle'           : False,         # random split or not
        #'train_size'        : 40,            # if train_size is a number, then use TRAIN_SIZE labels per class.
        'train_size'        : 873,            # if train_size is a number, then use TRAIN_SIZE labels per class.
        #'train_size'        : 1227,            # if train_size is a number, then use TRAIN_SIZE labels per class.
